...
for subject_label in subject_labels:
    ...
    subjectfolder_glm = Path(subject_folder, run_level_glm_folder)
    effects = []
    beta_maps = []
    runs = []
    for run_label in run_labels:
       for effect_label in effect_labels:
            ...
            beta_map = glob.glob(f"{subjectfolder_glm}/{task}*{subject_label}*{run_label}*{effect_label}*6*beta_map.nii.gz")[0]
