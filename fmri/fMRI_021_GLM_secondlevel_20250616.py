...
for contrast in contrasts_to_model:
    ...
    output_file = rf'{derivatives_folder}/{task}_secondlevel_glm_{contrast}_smooth_6_z_map.nii.gz'
    ...
    output_file     =  rf'{derivatives_folder}/{task}_secondlevel_glm_{contrast}_uncorrected_p={p_val}_surface.png'
    plotting.plot_img_on_surf(
        ...
        colorbar        = True,
        darkness        = 1.0,
        title           = f'{task}_secondlevel_glm_{contrast}_uncorrected_p={p_val}_20250618',
