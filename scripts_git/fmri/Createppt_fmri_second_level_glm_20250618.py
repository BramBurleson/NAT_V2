...
output_pptx = rf"{derivatives_folder}\single_subject_glm_smooth_6_20250616_FF.pptx"
...
max_col_num = 5
num_rows = 1 #len(subject_labels)//max_col_num + 1
...
for c, contrast_name in enumerate(contrast_names):
    ...
    for s, subject_label in enumerate(subject_labels):
        ...
        image = list(subject_folder.glob(f'*{subject_label}*{contrast_name}*.png'))[0]
